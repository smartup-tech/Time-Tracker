...
public class ReportHoursForEmployeesMapper implements RowMapper<ReportHours> {
    ...
    public ReportHours mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        reportHours.setEmployeeId(rs.getInt("employee_id"));
        reportHours.setEmployeeFirstName(rs.getString("employee_first_name"));
        reportHours.setEmployeeLastName(rs.getString("employee_last_name"));
